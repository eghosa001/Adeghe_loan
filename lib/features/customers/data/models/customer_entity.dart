...
class Customer {
  ...
  /// Sum of `outstanding_balance` across this customer's active loans. A
  /// read-model field only — populated by list queries (`total_owed`), never
  ...
  factory Customer.fromMap(Map<String, Object?> map) => Customer(
    ...
    totalOwed: (map['total_owed'] as num?)?.toDouble() ?? 0,
  );
}
