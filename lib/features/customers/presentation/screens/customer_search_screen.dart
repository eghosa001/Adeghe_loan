...
class CustomerListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final hasMore =
        (currentPage + 1) * AppConstants.defaultPageSize < totalCount;
                      ...
                      child: FilterChip(
                        ...
                        onSelected: (_) {
                          ref
                              ...
                              .state = selectedGroup == ungroupedGroupFilter
                              ? null
                    ...
                    builder: (context, ref, _) {
                      ...
                      return DropdownButtonHideUnderline(
                        child: DropdownButton<CustomerSortBy>(
                          ...
                          items: const [
                            DropdownMenuItem(
                              value: CustomerSortBy.name,
                              child: Text('Name'),
                            ),
                            DropdownMenuItem(
                              value: CustomerSortBy.group,
                              child: Text('Group'),
                            ),
                            DropdownMenuItem(
                          ...
                          onChanged: (value) {
                            ref.read(customerSortByProvider.notifier).state =
                                value!;
                            ref.read(customerPageProvider.notifier).state = 0;
                          },
                        ),
